...
export function Layout() {
  ...
  return (
    <div className="flex h-dvh flex-col">
      <header className="flex items-center justify-between border-b border-line bg-surface px-4 py-2 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="flex items-center gap-2 text-sm font-semibold tracking-wide">
            <span
              aria-hidden
              className="relative h-[22px] w-[22px] shrink-0 rounded-md bg-gradient-to-br from-accent-blue to-accent-blue-2 shadow-sm ring-1 ring-inset ring-surface/40"
            >
              <span className="absolute right-[3px] top-[3px] h-1.5 w-1.5 rounded-full bg-accent-orange" />
            </span>
